// ── Agent Access Layer — Brand Asset API + MCP server ────────────────
// Gives AI agents / builders programmatic access to the Baddies Tax Services brand system.
...
export const DESIGN_TOKENS = {
  meta: { brand: BADDIES_TAX_TOKENS.brandName, version: '1.0' },
  colors: BADDIES_TAX_TOKENS.colors,
  typography: BADDIES_TAX_TOKENS.typography,
  legal: BADDIES_TAX_TOKENS.legal,
